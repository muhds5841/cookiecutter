...
class TestFTPClient(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.client = FTPClient(
            host="ftp.example.com", port=21, username="user", password="password", use_tls=False
        )
    ...
    def test_list_files(self):
        ...
        self.mock_ftp_instance.retrlines.assert_called_once_with(
            "LIST", self.mock_ftp_instance.retrlines.call_args[0][1]
        )
    ...
    def test_upload_file(self):
        ...
        self.mock_ftp_instance.storbinary.assert_called_once_with(
            "STOR /remote/path/remote.txt", mock_file
        )
    ...
    def test_download_file(self):
        ...
        self.mock_ftp_instance.retrbinary.assert_called_once_with(
            "RETR /remote/path/remote.txt", mock_file.write
        )
    ...
    def test_health(self):
        ...
        self.mock_health_check_instance.get_status.return_value = {
            "status": "healthy",
            "checks": {
                "ftp_connection": {"status": "healthy", "details": {"server": "ftp.example.com:21"}}
            },
        }
        ...
        self.assertEqual(
            health["checks"]["ftp_connection"]["details"]["server"], "ftp.example.com:21"
        )
