...
class IMAPServer:
    ...
    def __init__(self, config: Dict[str, Any] = None):
        ...
        if self.enable_metrics:
            ...
            self.metrics.register_counter("imap_commands_total", "Total number of IMAP commands processed")
            self.metrics.register_counter("imap_errors_total", "Total number of IMAP errors")
            self.metrics.register_gauge("imap_active_connections", "Number of active IMAP connections")
            self.metrics.register_histogram("imap_command_processing_time", "Time to process IMAP commands")
    ...
    def _start_health_server(self):
        ...
        def run_server():
            ...
            self.logger.info(f"Serwer HTTP dla health check uruchomiony na {self.host}:{health_port}")
