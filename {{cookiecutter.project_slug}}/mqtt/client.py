...
class ProcessClient:
    ...
    def __init__(self, broker_host: str = "localhost", broker_port: int = 1883, config: Dict[str, Any] = None):
        ...
        try:
            ...
            with self.lock:
                if request_id in self.pending_requests:
                    ...
                    self.logger.warning(f"Otrzymano odpowiedź dla nieznanego request_id: {request_id}")
