...
class PluginRegistry:
    ...
    def get_plugin_instance(self, name: str, config: Optional[Dict[str, Any]] = None) -> Optional[ProcessBase]:
            ...
            try:
                ...
                for name, obj in inspect.getmembers(module):
                    if (inspect.isclass(obj) and 
                        issubclass(obj, ProcessBase) and 
                        obj != ProcessBase):
...
class PluginBase(ProcessBase):
    ...
    def __init__(self):
        ...
        self.logger = get_logger(f"process.plugins.{self.PLUGIN_NAME or self.__class__.__name__.lower()}")
        self.config = {}
...
class ExamplePlugin(PluginBase):
    ...
    def get_available_resources(self) -> List[Dict[str, Any]]:
        ...
        """
        return [
            {"name": "example-resource", "type": "example", "description": "Example resource"}
        ]
