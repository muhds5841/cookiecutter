        ...
        return {
            ...
            "parameters": {
                ...
                "properties": {
                    ...
                    "voice": {"type": "string", "description": "Nazwa głosu do użycia"},
                    "format": {
                        "type": "string",
            ...
            "returns": {"type": "string", "description": "Identyfikator URI zasobu"},
        }
        ...
        return {
            ...
            "returns": {
                ...
                "items": {
                    "type": "object",
                    "properties": {
                        "name": {"type": "string", "description": "Nazwa zasobu"},
                        "type": {"type": "string", "description": "Typ zasobu"},
                        "metadata": {"type": "object", "description": "Metadane zasobu"},
                    },
                },
            },
        }
        ...
        try:
            ...
            if uri == "resources://voices":
                ...
                return [
                    ...
                    for lang in self.process.get_available_languages()
                ]
            else:
    ...
    def get_schema(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "returns": {
                "type": "object",
                "properties": {
                    "resource_id": {"type": "string", "description": "Identyfikator zasobu"},
                    "format": {"type": "string", "description": "Format zasobu"},
                    "base64": {"type": "string", "description": "Dane zakodowane w base64"},
                },
            },
        }
...
class ProcessToolProvider:
    ...
    def get_resource_providers(self) -> List[Dict[str, Any]]:
        ...
        """
        return [self.resource_provider.get_schema(), self.output_provider.get_schema()]
