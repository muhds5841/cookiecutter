    ...
    def get_schema(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "parameters": {
                "type": "object",
                "properties": {
                    "text": {"type": "string", "description": "Tekst do konwersji na mowę"},
                    "language": {
                        "type": "string",
            ...
            "returns": {"type": "string", "description": "Identyfikator URI zasobu audio"},
        }
        ...
        return {
            ...
            "returns": {
                ...
                "items": {
                    "type": "object",
                    "properties": {
                        "name": {"type": "string", "description": "Nazwa głosu"},
                        "language": {
                            "type": "string",
                            "description": "Kod języka (np. 'en-US', 'pl-PL')",
                        },
                        "gender": {"type": "string", "description": "Płeć głosu (male, female)"},
                    },
                },
            },
        }
...
class LanguageResourceProvider:
    ...
    def get_schema(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "returns": {
                "type": "array",
                "items": {"type": "string", "description": "Kod języka (np. 'en-US', 'pl-PL')"},
            },
        }
    ...
    def get_schema(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "returns": {
                "type": "object",
                "properties": {
                    "audio_id": {"type": "string", "description": "Identyfikator audio"},
                    "format": {"type": "string", "description": "Format audio (wav, mp3)"},
                    "base64": {"type": "string", "description": "Dane audio zakodowane w base64"},
                },
            },
        }
